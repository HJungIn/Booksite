	...
	<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link" href="<c:url value="/aladin"/>"> Aladin's Books </a></li>
				
				<li class="nav-item"><a class="nav-link" href="<c:url value="/books"/>"> My DB Books </a></li>
				
				<%-- <li class="nav-item"><a class="nav-link disabled" href="<c:url value="/admin"/>">Admin</a></li> --%>
